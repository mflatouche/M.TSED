...
## Módulo 1 - Actividad 3. Potencia de la corriente
...
| [Anterior](../1_ClasificacionRios) | [:house: Inicio](../../README.md) | [:beginner: Ayuda](https://github.com/mflatouche/M.TSED/discussions/3)  | [Siguiente](../1_MovimientoIncipiente) |
|------------------|-----------------------------------------------------------|------------------------------------------------------------------------|-------------------|
